...
class QLearning:
    def __init__(self, env, alpha=1, batch_size=1, max_iterations=100, trajectories=100, epsilon=0, theta_size=9, epsilon_greedy_val=0):
        self.env = env
        self.alpha = alpha
    ...
    def train(self, eval_by_n_starts=10):
        ...
        data = DataSet(self.env, N=self.batch_size, trajectories=self.trajectories, method='Q_learning', iteration=iteration, epsilon_greedy_val=self.epsilon_greedy_val)
